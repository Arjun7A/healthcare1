      ...
      <div className="results-view">
        ...
        <div className="detailed-sections">
          <div className="section-tabs">
            <button className="tab active">📊 Dosing</button>
            <button className="tab">💊 Administration</button>
            <button className="tab">⚠️ Side Effects</button>
            <button className="tab">🔬 Monitoring</button>
