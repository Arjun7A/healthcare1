    ...
    <div className="dashboard">
      ...
      <main className="dashboard-main">
        <div className="container">
            ...
            <>
              ...
              <div className="features-grid">
                ...
                <div 
                  ...
                  onClick={() => handleSectionChange('prescription-explainer')}
                >
                  <div className="feature-icon">
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                  ...
                  <div className="feature-content">
                    <h3>💊 Prescription Explainer</h3>
                    <p>AI-powered prescription analysis and safety guidance</p>
                    <div className="feature-badges">
                      <span className="badge">🧠 AI Analysis</span>
                      <span className="badge">⚠️ Drug Interactions</span>
                      <span className="badge">📋 Safety Checks</span>
                    </div>
                  </div>
                </div>
                ...
                <div 
                  ...
                  onClick={() => handleSectionChange('medicine-explainer')}
                >
                  <div className="feature-icon">
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                  ...
                  <div className="feature-content">
                    <h3>🔍 Medicine Explainer</h3>
                    <p>Comprehensive medication information and comparisons</p>
                    <div className="feature-badges">
                      <span className="badge">💊 Drug Info</span>
                      <span className="badge">⚖️ Comparisons</span>
                ...
                <div 
                  ...
                  onClick={() => handleSectionChange('health-reports')}
                >
                  <div className="feature-icon">
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
          ...
          {activeSection === 'prescription-explainer' && (
            <div className="section-content">
              <div className="section-header">
                <Button 
                  onClick={() => handleSectionChange('overview')} 
          ...
          {activeSection === 'medicine-explainer' && (
            <div className="section-content">
              <div className="section-header">
                <Button 
                  onClick={() => handleSectionChange('overview')} 
              ...
              <div className="medicine-explainer-container">
                <MedicineExplainer />
              </div>
            </div>
          )}
